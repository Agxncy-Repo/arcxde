...
> **Purpose:** Capture the _why_ behind every significant technical decision.
...
- **Dated** — context drifts; you want to know _when_ a call was made.
...
- Decide _not_ to do something the team expected you would.
