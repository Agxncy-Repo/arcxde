-- AlterTable
ALTER TABLE "Identity" ALTER COLUMN "id" SET DEFAULT 'iden_' ||gen_random_uuid()::text;

-- AlterTable
ALTER TABLE "Session" ALTER COLUMN "id" SET DEFAULT 'ses_' || gen_random_uuid()::text;
...
CREATE TABLE "VerificationCode" (
    "id" TEXT NOT NULL DEFAULT 'vc_' || gen_random_uuid()::text,
...
CREATE TABLE "EmailVerificationSession" (
    ...
    CONSTRAINT "EmailVerificationSession_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "EmailVerificationSession_email_idx" ON "EmailVerificationSession"("email");
