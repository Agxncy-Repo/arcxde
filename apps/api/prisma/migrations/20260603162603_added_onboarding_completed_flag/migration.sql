-- AlterTable
ALTER TABLE "EmailVerificationSession" ALTER COLUMN "id" SET DEFAULT 'evs_' || gen_random_uuid()::text;
...
-- AlterTable
ALTER TABLE "VerificationCode" ALTER COLUMN "id" SET DEFAULT 'vc_' || gen_random_uuid()::text;
