...
-- AddForeignKey
ALTER TABLE "email_verification_sessions" ADD CONSTRAINT "email_verification_sessions_email_fkey" FOREIGN KEY ("email") REFERENCES "users"("email") ON DELETE CASCADE ON UPDATE CASCADE;
